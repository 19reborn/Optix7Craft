...
public:
    ...
    void setSunTheta(float sun_theta) { m_sun_theta = sun_theta; m_dirty = true; }
    void setSunPhi(float sun_phi) { m_sun_phi = sun_phi;     m_dirty = true; }
    void setTurbidity(float turbidity) { m_turbidity = turbidity; m_dirty = true; }

    void setUpDir(const float3& up) { m_up = up; m_dirty = true; }
    ...
    float3 getSunDir() { preprocess(); return m_sun_dir; }
